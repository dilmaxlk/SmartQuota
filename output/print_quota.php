...
<html>
    <head>
        ...
        <title>Quotation | <?php echo $_GET['quo_id']; ?></title>
...
?>         
                    ...
                    <div class="col-sm-4 invoice-col" style=" padding-bottom: 20px;">
                        <h3>Quotation ID: <?php echo $_GET['quo_id']; ?></h3>
                        <b>Subject:</b> <?php echo $quo_subject; ?><br>
                        <b>Created Date:</b> <?php echo $quo_date_created; ?> <br>
                        <b>Stage:</b> <?php echo $quo_stage; ?> <br>
                        <b>Valid Until:</b> <?php echo $quo_valid_untill; ?>
                    </div><!-- /.col -->
                </div><!-- /.row -->
...
while ($stmt_get_quota_item_details->fetch()) {
    ?>                 
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <p class="lead">About Proposal:</p>
                        <p class="text-muted well well-sm no-shadow" style="white-space: pre-wrap;"><?php echo $quo_proposal_text; ?></p>

                        <p class="lead">Customer Notes:</p>
                        <p class="text-muted well well-sm no-shadow" style="white-space: pre-wrap;"><?php echo $quo_customer_notes; ?></p>
                    </div><!-- /.col -->
                    <div class="col-xs-6">
